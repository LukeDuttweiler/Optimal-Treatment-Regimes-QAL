### created at 06/25/2019 the real example for ALS data set
...
real_logit_surv_new = list(temp3 = temp3, temp4 = temp4)
#real_hal_new = list(temp1 = real_hal$temp1, temp2 = real_hal$temp2, temp3 = real_hal$temp3, temp4 = real_hal$temp4 ,
...
save(real_logit_surv_new, file = "real_logit_surv_all.rda")
...
### the opt case
sc_opt = surv_curve(real_logit_surv$temp1$par, index)
