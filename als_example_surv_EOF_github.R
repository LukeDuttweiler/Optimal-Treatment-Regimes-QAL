...
real_logit_surv_EOF = list(temp1 = temp1, temp2 = temp2, temp3 = temp3, temp4 = temp4 ,
                      temp5 = temp5, temp6 = temp6, temp7 = temp7, temp8 = temp8, temp9 = temp9, temp10 = temp10, temp11 = temp11, temp12 = temp12)
setwd("~/Dropbox/Hsun/Research project/Causal Inference/ALS case study/QAL/code_github")
save(real_logit_surv_EOF, file = "real_logit_surv_EOF.rda")
